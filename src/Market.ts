...
import { createOrderHash, signOrderHash, tradeOrder } from './lib/Order';
...
export class Market {
   ...
   */
  public async createOrderHash(order: Order | SignedOrder): Promise<string> {
    return createOrderHash(this._web3.currentProvider, order);
  }
   ...
   */
  public async signOrderHash(orderHash: string, signerAddress: string): Promise<ECSignature> {
    return signOrderHash(this._web3.currentProvider, orderHash, signerAddress);
  }
   ...
   */
  public async tradeOrder(signedOrder: SignedOrder, fillQty: number): Promise<boolean> {
    return tradeOrder(this._web3.currentProvider, signedOrder, fillQty);
  }
}
